<!-- deterministic-state-bridge: ggen -->

**Machine-generated operational state:** see [`.repo/STATUS.md`](./.repo/STATUS.md) (generated by `tools/repo_knowledge`). For cross-project SKB registry state, see [`projects/registry/ggen.json`](../../projects/registry/ggen.json) in the parent SKB repository.
# GGEN Current State

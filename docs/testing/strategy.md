...
8. Physical device: backend verification, thermals, memory, latency, canvas frame budget, stylus/touch. Interaction is performed by the **owner**; the Supervisor observes, collects scoped evidence, analyzes and fixes — see `../ADB_FIRST_TESTING.md` and `DEC-2026-09-21-001` in `soobujmiah/skb`.

                      ...
                      children: [
                        ...
                        if (workspaceActions.isNotEmpty) ...[
                          ...
                          ...workspaceActions.map((a) => _buildCategorizedRow(
                            sheetContext, a, reorderIndex, reorderActive: reorderIndex != null,
                            setSheetState, exitReorder, moveRow, setState,
                          )),
...
class _ColumnsSheetState extends State<_ColumnsSheet> {
  ...
  void _unlink() {
    ...
    debugLog.info('inspector_flow_unlink', 'Inspector unlinked text frame', {
      'source': widget.selectedId.value,
      'revision': widget.controller.revision,
    });
  }
